...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _ChooseMethod value)?  chooseMethod,TResult Function( _EmailEntry value)?  emailEntry,TResult Function( _EmailLinkSending value)?  emailLinkSending,TResult Function( _EmailLinkSent value)?  emailLinkSent,TResult Function( _EmailLinkVerifying value)?  emailLinkVerifying,TResult Function( _GoogleSigningIn value)?  googleSigningIn,TResult Function( _Success value)?  success,TResult Function( _Error value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return emailLinkVerifying(_that);case _GoogleSigningIn() when googleSigningIn != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _ChooseMethod value)  chooseMethod,required TResult Function( _EmailEntry value)  emailEntry,required TResult Function( _EmailLinkSending value)  emailLinkSending,required TResult Function( _EmailLinkSent value)  emailLinkSent,required TResult Function( _EmailLinkVerifying value)  emailLinkVerifying,required TResult Function( _GoogleSigningIn value)  googleSigningIn,required TResult Function( _Success value)  success,required TResult Function( _Error value)  error,}){
final _that = this;
switch (_that) {
case _ChooseMethod():
...
return emailLinkVerifying(_that);case _GoogleSigningIn():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _ChooseMethod value)?  chooseMethod,TResult? Function( _EmailEntry value)?  emailEntry,TResult? Function( _EmailLinkSending value)?  emailLinkSending,TResult? Function( _EmailLinkSent value)?  emailLinkSent,TResult? Function( _EmailLinkVerifying value)?  emailLinkVerifying,TResult? Function( _GoogleSigningIn value)?  googleSigningIn,TResult? Function( _Success value)?  success,TResult? Function( _Error value)?  error,}){
final _that = this;
switch (_that) {
case _ChooseMethod() when chooseMethod != null:
return chooseMethod(_that);case _EmailEntry() when emailEntry != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  chooseMethod,TResult Function( String email,  bool isValid,  String? errorMessage)?  emailEntry,TResult Function( String email)?  emailLinkSending,TResult Function( String email,  int resendCountdown)?  emailLinkSent,TResult Function( String email)?  emailLinkVerifying,TResult Function()?  googleSigningIn,TResult Function( User user)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChooseMethod() when chooseMethod != null:
...
return emailLinkVerifying(_that.email);case _GoogleSigningIn() when googleSigningIn != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  chooseMethod,required TResult Function( String email,  bool isValid,  String? errorMessage)  emailEntry,required TResult Function( String email)  emailLinkSending,required TResult Function( String email,  int resendCountdown)  emailLinkSent,required TResult Function( String email)  emailLinkVerifying,required TResult Function()  googleSigningIn,required TResult Function( User user)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _ChooseMethod():
...
return emailLinkVerifying(_that.email);case _GoogleSigningIn():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  chooseMethod,TResult? Function( String email,  bool isValid,  String? errorMessage)?  emailEntry,TResult? Function( String email)?  emailLinkSending,TResult? Function( String email,  int resendCountdown)?  emailLinkSent,TResult? Function( String email)?  emailLinkVerifying,TResult? Function()?  googleSigningIn,TResult? Function( User user)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _ChooseMethod() when chooseMethod != null:
return chooseMethod();case _EmailEntry() when emailEntry != null:
return emailEntry(_that.email,_that.isValid,_that.errorMessage);case _EmailLinkSending() when emailLinkSending != null:

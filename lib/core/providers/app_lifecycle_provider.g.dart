...
final class AppLifecycleProvider extends $NotifierProvider<AppLifecycle, bool> {
...
String _$appLifecycleHash() => r'b3c1e2d4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0';

abstract class _$AppLifecycle extends $Notifier<bool> {
  bool build();
  @$mustCallSuper
  @override
  void runBuild() {
